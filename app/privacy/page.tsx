...
export default function PrivacyPage() {
  ...
  const sections = [
    ...
    [tr('案例与证据', 'Cases and evidence'), tr('公开案例移除姓名、申请编号、联系方式及可直接识别个人的信息。少量匿名结果样本仅用于说明历史档案，不构成院校背书或未来结果承诺。', 'Public cases remove names, application numbers, contact details and directly identifying information. Limited anonymised outcome samples illustrate historical records only and do not imply institutional endorsement or future outcomes.')],
    ...
    [tr('结果与责任边界', 'Outcome and responsibility boundaries'), tr('历史录取、项目、就业或研究记录不构成未来录取、签证、就业、发表或商业结果承诺。具体服务范围与双方责任以正式书面确认为准。', 'Past admission, programme, employment or research records do not guarantee future admission, visa, employment, publication or commercial outcomes. Service scope and responsibilities follow the formal written agreement.')],
